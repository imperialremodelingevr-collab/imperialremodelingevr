        ...
        <div className="fcol fbrand">
          ...
          <div className="fsocial">
            ...
            <div className="fsocial-row">
              <a className="soc" href="https://www.facebook.com/ernesto.velez.994940" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
              ...
              <a className="soc" href="https://www.instagram.com/imperialremodeling/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="2.5" y="2.5" width="19" height="19" rx="5.2" /><circle cx="12" cy="12" r="4.2" /><circle cx="17.4" cy="6.6" r="1.1" fill="currentColor" stroke="none" /></svg>
              </a>
